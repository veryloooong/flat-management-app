  ...
  return (
    <div className="flex flex-col md:flex-row p-6 space-x-4">
      ...
      <div className="flex-1 bg-white rounded-lg p-6 shadow-md">
        <h1 className="text-3xl font-bold text-main-palette-7 mb-6">Thông tin cư trú</h1>
        <div className="mb-4 flex border-b justify-between">
          <label className="block font-semibold">Họ và tên</label>
          <p className="text-gray-700">Nguyễn Hoàng Việt</p>
        </div>
        <div className="mb-4 flex border-b justify-between">
        ...
        <div className="mb-4 flex border-b justify-between">
          ...
          <p className="text-gray-700">169</p>
        </div>
      </div>
      ...
      <div className="flex-1 space-y-6">
        {/* Pending Payment Section with Scrollable Area */}
          <div className="bg-main-palette-1 rounded-lg p-4">
            <h2 className="text-2xl font-bold text-gray-700 mb-4 ">Các khoản cần đóng</h2>
            ...
            <div className="bg-white p-4 rounded-lg mb-4  shadow">
              <div className="flex items-center mb-2 border-b">
                ...
                <h3 className="text-lg font-semibold">Tiền điện tháng 12/2024</h3>
              </div>
              <p>Phòng: 169</p>
            ...
            <div className="bg-white p-4 rounded-lg mb-4 shadow">
              <div className="flex items-center mb-2 border-b">
                <span className="mr-2 text-yellow-600">⚠️</span>
                <h3 className="text-lg font-semibold">Tiền nước tháng 12/2024</h3>
              </div>
              <p>Phòng: 169</p>
            ...
            <div className="bg-white p-4 rounded-lg mb-4 shadow">
              <div className="flex items-center mb-2 border-b">
                <span className="mr-2 text-yellow-600">⚠️</span>
                <h3 className="text-lg font-semibold">Tiền điện tháng 11/2024</h3>
              </div>
              <p>Phòng: 169</p>
        ...
        <div className="bg-main-palette-1 rounded-lg p-4">
          <h2 className="text-2xl font-bold text-gray-700 mb-4">Lịch sử giao dịch</h2>
          <div className="bg-main-palette-3 rounded-lg p-6 shadow-md overflow-y-auto max-h-96">
            
            <div className="bg-white p-4 rounded-lg mb-4 shadow">
              <div className="flex items-center mb-2 border-b">
                <span className="mr-2 text-green-600">✅</span>
                <h3 className="text-lg font-semibold">Tiền quỹ thiện nguyện tháng 11/2024</h3>
              </div>
              <p>Phòng: 169</p>
            ...
            <div className="bg-white p-4 rounded-lg mb-4 shadow">
              <div className="flex items-center mb-2 border-b">
                <span className="mr-2 text-green-600">✅</span>
                <h3 className="text-lg font-semibold">Tiền nước tháng 11/2024</h3>
              </div>
              <p>Phòng: 169</p>
